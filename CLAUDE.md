...
- **UI work must follow the design system** — see [docs/design-system.md](docs/design-system.md) for stack rules, tokens, component conventions, and layout structure.
