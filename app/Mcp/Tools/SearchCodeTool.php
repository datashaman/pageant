...
#[Description('Search for code in a GitHub repository. Use GitHub search syntax, e.g. "className repo:owner/repo".')]
#[IsReadOnly]
#[IsOpenWorld]
class SearchCodeTool extends Tool
{
    ...
    public function handle(Request $request): Response
    {
        ...
        $results = $this->github->searchCode($installation, $fullQuery);
